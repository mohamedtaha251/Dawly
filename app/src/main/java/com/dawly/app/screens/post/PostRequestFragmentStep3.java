...
import app.dawly.com.dawly.databinding.FragmentPostRequest3Binding;
import com.dawly.app.base.BaseFragment;
import com.dawly.app.views.DawlyButtonBold;

public class PostRequestFragmentStep3 extends BaseFragment implements View.OnClickListener {

    private FragmentPostRequest3Binding fragmentPostRequestBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fragmentPostRequestBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_post_request3, container, false);
