...
package com.dawly.app.screens.scan.mrz;
...
import com.dawly.app.screens.scan.ScanActivity;
...
public class ScanMrzActivity extends ScanActivity implements CameraOpenListener, AnylineDebugListener {
    ...
    void init() {
        ...
        //init the scan view
        IdScanViewPlugin scanViewPlugin = new IdScanViewPlugin(getApplicationContext(), getString(R.string.license_key), mrzScanView.getScanViewPluginConfig(), mrzConfig);
        ...
        scanViewPlugin.addScanResultListener(new ScanResultListener<ScanResult<ID>>() {
            ...
            public void onResult(ScanResult<ID> idScanResult) {
                ...
                Bitmap face = identification.getFaceImage();
                AnylineImage faceImg = new AnylineImage(face);
                String path = setupImagePath(idScanResult.getCutoutImage());
                String facePath = setupImagePath(faceImg);
